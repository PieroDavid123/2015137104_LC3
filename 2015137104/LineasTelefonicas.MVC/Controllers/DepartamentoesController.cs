...
namespace LineasTelefonicas.MVC.Controllers
{
    public class DepartamentoesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "DepartamentoId")] Departamento departamento)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "DepartamentoId")] Departamento departamento)
        {
            if (ModelState.IsValid)
            {
